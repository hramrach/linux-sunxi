...
out:
	/*
	 * Either a PIO transfer has ended and the FIFO now contains the data
	 * or the FIFO is empty or something has failed and the FIFO may
	 * contain garbage.
	 * Either way remove any data possibly copying them to rx buffer.
	 */
