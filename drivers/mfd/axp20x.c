...
static struct resource axp152_main_power_supply_resources[] = {
	DEFINE_RES_IRQ_NAMED(AXP152_IRQ_LDO0IN_PLUGIN, "LDO0IN_PLUGIN"),
	DEFINE_RES_IRQ_NAMED(AXP152_IRQ_LDO0IN_REMOVAL, "LDO0IN_REMOVAL"),
};

static struct resource axp152_aux_power_supply_resources[] = {
	DEFINE_RES_IRQ_NAMED(AXP152_IRQ_ALDO0IN_PLUGIN, "ALDO0IN_PLUGIN"),
	DEFINE_RES_IRQ_NAMED(AXP152_IRQ_ALDO0IN_REMOVAL, "ALDO0IN_REMOVAL"),
};
